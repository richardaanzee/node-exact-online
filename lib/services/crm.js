 ...
 * @param  {Function} callback  Callback
 */
CRM.prototype.saveBankAccount = function(bankAccount, userData, division, callback) {
  ...
  this.client.sendRequest('/v1/' + division + '/crm/BankAccounts(guid\'' + bankAccount.d.results[0].ID + '\')', 'PUT', null, userData, callback);
};
